...
import StatParProducteur from 'src/gestion-bars/logic/models/StatParProducteur'
...
const TemplateDesStatsParProducteursRC: React.FC<PdfDocumentProps> = ({ data, fileName, date_debut, date_fin }) => {
  const generatePdf = () => {
    const tableBody = [
      [
...
export default TemplateDesStatsParProducteursRC
